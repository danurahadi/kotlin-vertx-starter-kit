...
import com.starter.app.domain.admin.handler.ActivityLogHandler
...
/**
 * Router class for Activity Logs resources
 *
...
class ActivityLogApiController @Inject constructor(
    override val router: Router,
    private val securityService: SecurityService,
    private val activityLogHandler: ActivityLogHandler
) : Controller({
    ...
    get("/").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "activity.logs")
        activityLogHandler.getActivityLogs(this)
    }
})
