...
/**
 * Router class for Setting Groups resources
 *
...
class SettingGroupApiController @Inject constructor(
    ...
    post("/").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.create")
        settingGroupHandler.createSettingGroup(this)
    }

    get("/").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.list")
        settingGroupHandler.getSettingGroupList(this)
    }
    get("/all").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.all")
        settingGroupHandler.getAllSettingGroups()
    }

    get("/:id").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.details")
        settingGroupHandler.getSettingGroupDetails(this)
    }

    put("/:id").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.update")
        settingGroupHandler.updateSettingGroup(this)
    }
    delete("/:id").jsonAsyncHandler {
        securityService.isUserAuthorized(userRole = this.get("roleName"), accessName = "setting-groups.delete")
        settingGroupHandler.deleteSettingGroup(this)
    }
})
